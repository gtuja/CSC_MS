...
- [TOC](#toc)<br>
- MS開発とは、***小型***コンピュータとも言えるMCUの開発であり、MCUに内臓されている**メモリ**、**プログラマブル ペリフェラル**を用いて行います。
...
- [TOC](#toc)<br>
- 世界のマイクロコントローラー市場規模は2023年に323億7,000万米ドル、***48兆円***と評価され、***2024年から2030年***までの年平均成長率は***11.7%***で拡大すると予測されています。
- アジアマーケット<br>
...
- データシート
  - データシートとは、メーカーが提供するMCU***特長、機能、ピン配置、メモリマッピング、電気的特性***が説明されてあり、MCU開発の最初の一歩です。
  - データシートには、クロック、メモリ、TIM#、ADC# などの***定量的な情報***が定義されてあり、システムの***MCU選定時***にもよく使われます。  
...
- Timer 
  - MCU搭載製品の多くは***リアルタイム性***を求めており、応答時間は重要な要素です。
  - MCUは複数のTimerを内臓しており、それぞれのTimerは独立・連動するように設定することが可能です。
  - Timerはペリフェラルクロックと割り込みでの実装が一般的で、Timer自体はMCUプログラムに依存しなく、割り込みレベルを調整すればリアルタイム性を高められます。

- ADC (Analog-to-Digital Converter)
  - ADCはペリフェラル機能の一つで、その名の通り***input***ポートに入力されるアナログ信号(電圧レベル)をデジタル化します。
　- リファレンス電圧、内臓オペアンプを使うノイズリダクションなど掘れば技術的なネタは多いはず？がここでは基本だけ押さえておきましょう。

- UART (Universal Asynchronous Receiver Transmitter)
  - UARTはシリアル通信の基本で、***I/O(TX/RX)***の2線で繋ぐ通信方式です。
  - これも掘ればRS-485, 全二重方式など色々ありますが、
