...
- [TOC](#toc)<br>
- As can be seen from [Trends], the MS industry is dominated by five major supplier (NXP, Microchip, Renesas, ST, Infineon), and it is no exaggeration to say that [ARM](https://www.arm) has been manipulated.
