...
- [Part1](https://github.com/gtuja/CSC_MS/blob/main/Part1/1.What%20is%20MS.md)の市場
- この章では[Git](https://git-scm.com/)、[Stm32 Cube IDE](https://www.st.com/en/development-tools/stm32cubeide.html)の基本操作を順に追って実習します。
