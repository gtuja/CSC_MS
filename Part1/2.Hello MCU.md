...
- この章ではデファクトVCSの[Git](https://git-scm.com/)とマイコン市場の5大勢力一角の[ST](https://www.st.com/en/)の[評価ボード(NUCLEO-G0B1RE)](https://www.st.com/ja/evaluation-tools/nucleo-g0b1re.html)を用いて、開発環境構築と基本操作を順に追って実習します。
...
12. 下記内容は[Part.2](https://github.com/gtuja/CSC_MS/blob/main/Part2/1.WorFlowOnGithub.md)以降で必要に応じて、実習する予定ですので、今のところは名前ぐらい覚えておきましょう。
  - ***Revision Graph***
  - ***Merge***
  - ***Tag***
  - ***Rebase***
