...
- マイコン市場はTop5の[NXP](https://www.nxp.com/), [Microchip](https://www.microchip.com/), [Renesas](https://www.renesas.com/), [ST](https://www.st.com/content/st_com/en.html), [Infineon](https://www.infineon.com/)が[82%を占めている](https://www.semiconportal.com/archive/editorial/market/220616-mcuranking.html)かつ、ARM一択の設計標準化もかなり進行しています。
- この章ではVCSのデファクト[Git](https://git-scm.com/)とマイコン市場の5大勢力の一角[ST](https://www.st.com/en/)の[評価ボード(NUCLEO-G0B1RE)](https://www.st.com/ja/evaluation-tools/nucleo-g0b1re.html)を用いて、開発環境構築と基本操作を順に追って実習します。
...
- [Linus Torvalds](https://en.wikipedia.org/wiki/Linus_Torvalds)?
  ...
  - 現在GitはデファクトVCSとなっており、2022年の報告によると、**95%の開発者**がメインVCSとして使われているようです。
  - 下位5%とはさすがにね。
...
12. 下記内容は[Part.2](https://github.com/gtuja/CSC_MS/blob/main/Part2/1.WorFlowOnGithub.md)以降で実習予定ですので、今のところは名前ぐらい覚えておきましょう。
  - ***Revision Graph***
  - ***Merge***
  - ***Tag***
  - ***Rebase***
