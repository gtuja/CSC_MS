...
- マイコン市場はTop5のNXP, Renesas, STM, Infineon, Microchipが[82%を占めている](https://www.semiconportal.com/archive/editorial/market/220616-mcuranking.html)かつ、ARM一択の設計標準化もかなり進行しています。
- この章ではVCSのデファクト[Git](https://git-scm.com/)とマイコン市場の5大勢力の一角[Stm](https://www.st.com/en/development-tools/stm32cubeide.html)評価ボードを用いて、開発環境構築と基本操作を順に追って実習します。
